...
<h3 class="w-100 text-center  my-5">Добавить товар</h3>
        <div class="" style="width: 50rem; margin: 0 auto">
            ...
            <form action="createFurniture" method="POST">
                  <div class="mb-3 row">
                    <label for="name" class="col-sm-3 col-form-label">Марка Авто</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="name" name="name" value="${name}">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="color" class="col-sm-3 col-form-label">Модель Авто</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="color" name="color" value="${color}">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="size" class="col-sm-3 col-form-label">Цвет Авто</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="color" name="size" value="${size}">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="quantity" class="col-sm-3 col-form-label">Пробег авто</label>
                    <div class="col-sm-9">
