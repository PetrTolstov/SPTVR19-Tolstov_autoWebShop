...
<!--        <h1>Список товаров:</h1>-->
        ...
        <h3 class="w-100 text-center  my-5">Авто</h3>
                    ...
                    <img src="insertFile/${furniture.cover.path}"  class="card-img-top" alt="..." style="max-width: 12rem; max-height: 15rem">
                        <div class="card-body">
                            <h5 class="card-title">${furniture.name}</h5>
                                Марка: <p class="card-text">${furniture.color}</p>
                                Цвет: <p class="card-text">${furniture.size} </p>
                                Пробег <p class="card-text">${furniture.quantity} </p>
